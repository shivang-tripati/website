...
const DEFAULT_EFFECT_OPTIONS: Record<string, any> = {
    onSpeedUp: () => { },
    onSlowDown: () => { },
...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }: { effectOptions?: Record<string, any> }) => {
    ...
    useEffect(() => {
        ...
        class App {
            ...
            constructor(container: HTMLDivElement, options: Record<string, any> = {}) {
    ...
    `;
        ...
        class CarLights {
            ...
            constructor(webgl: App, options: Record<string, any>, colors: any, speed: any, fade: THREE.Vector2) {
                this.webgl = webgl;
                this.options = options;
                this.colors = colors;
                this.speed = speed;
            ...
            update(time: number) {
                if (this.mesh?.material && "uniforms" in this.mesh.material) {
    ...
    `;
        ...
        class LightsSticks {
            ...
            constructor(webgl: App, options: Record<string, any>) {
                this.webgl = webgl;
                this.options = options;
            }
